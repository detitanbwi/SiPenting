<footer class="py-4 bg-white border-t border-slate-100 mt-auto">
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-2">
            ...
            <div class="flex items-center gap-3 font-semibold">
                ...
                <span class="text-slate-300">&bull;</span>
                <a target="_blank" href="https://wa.me/6281216532315" class="text-sky-600 hover:text-sky-700 transition-colors">Kontak Pengembang</a>
            </div>
        </div>
    </div>
</footer>